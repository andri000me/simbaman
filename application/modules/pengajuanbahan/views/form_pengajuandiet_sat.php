...
$(document).ready(function () {
    $("#formoid").submit(function(event) {
        ...
        $.ajax({
            type: "POST",
            data: $(this).serialize(),
            url: "<?php echo base_url().'pengajuanbahan/savedata_pengajuandiet_sat'; ?>",
            beforeSend: function(){
                ...
                <form class="form-horizontal" id="formoid" action="" title="" method="post">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <input type="hidden" class="form-control" id="tanggalpengajuan" name="tanggalpengajuan" value="<?php echo $tanggalpengajuan;?>">
