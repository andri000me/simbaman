...
<div class="row" style="margin-bottom: 20px;">
    <div class="col-lg-12">
        <h3>Kelas : <?php echo $namakelas[0]['namakelas'];?></h3>
    </div>
</div>

<div class="row" style="margin-bottom: 20px;">
    <div class="col-lg-12">
        <a href="<?php echo base_url()?>menumasakan/loadform_menumasakan/<?php echo $namakelas[0]['idkelas'];?>" class="btn btn-success">Tambah Manu Kelas : <?php echo $namakelas[0]['namakelas'];?></a>
    </div>
</div>
