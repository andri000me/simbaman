...
$(document).ready(function () {
    ...
    $("#frm_upload").submit(function(event) {
        ...
        $.ajax({
            ...
            data: formData,
            async: false,
            url: "<?php echo base_url().'rekappasien/uploadfile'; ?>",   
            async: false,
            cache: false,
            contentType: false,
            processData: false,
    ...
    $("#frm_upload_json").submit(function(event) {
        ...
        $.ajax({
            ...
            data: formData,
            async: false,
            url: "<?php echo base_url().'rekappasien/uploadfile_json'; ?>",   
            async: false,
            cache: false,
            contentType: false,
            processData: false,
                ...
                <div class="col-lg-12">
                    <form class="form-horizontal" name="frm_upload" id="frm_upload" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <a href="<?php echo base_url()?>rekappasien/file_excel_default" class="btn btn-link">Format Default Upload Data Rekap Pasien</a>
                            </div>
                        </div>
                        <div class="form-group">
